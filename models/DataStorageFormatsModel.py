...
class DataStorageFormatsModel(Base):

    __tablename__ = "data_storage_formats"
    ...
    data_dictionaries = relationship('DataDictionariesModel', back_populates='data_storage_formats')
