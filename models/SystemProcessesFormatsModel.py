...
class SystemProcessesFormatsModel(Base):

    __tablename__ = "system_processes_formats"
    ...
    data_dictionaries = relationship('DataDictionariesModel', back_populates='system_processes_formats')
